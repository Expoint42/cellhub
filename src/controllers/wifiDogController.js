...
class WiFiDogController {
    ...
    portal (req, res, next) {
        ...
        // </head>
        // <body>
        //     <div id="btnGet" class='btn' onclick='window.open("${redirect_link}", "_blank");'>已连接</div>
        //     <script>
...
wired=0
     ...
     */
    auth (req, res) {
        if (req.query.token === "welcome_to_wifi") {
            res.send('Auth: 1')
        } else {
            res.send('Auth: 0')
        }
...
module.exports = new WiFiDogController();
